...
bad_text = \
    "Кажется, в вашем тикете есть плохие слова. Попробуйте сформулировать проблему еще раз"
...
chosen_military = \
    "Актуальная информация по ВУЦ: https://mil.bmstu.ru/"

chosen_admission = \
    "Актуальная информация по поступлению: https://priem.bmstu.ru/"
